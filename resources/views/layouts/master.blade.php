                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="user-profile">
                            <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><img src="{{ asset('assets/images/users/profile.png') }}" alt="user" /><span class="hide-menu">Steave Jobs </span></a>
            ...
            <!-- ============================================================== -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <img class="card-img-top img-fluid auto-height" src="{{ asset('assets/images/big/img1.jpg') }}" alt="Card image cap">
                            <div class="card-body">
